...
function validParentheses(parens) {
  ...
  for (let index = 0; index < parens.length; index++) {
    // index is the current index of the string
  ...
  for (let index = 0; index < str.length; index++) {
    ...
    if (currentChar.charCodeAt(0) >= 65 && currentChar.charCodeAt(0) <= 90) {
      ...
      if (newChar.charCodeAt(0) > 90) {
        // if the new character is greater than 90
      ...
      if (newChar.charCodeAt(0) > 122) {
        // if the new character is greater than 122
        newChar = String.fromCharCode(currentChar.charCodeAt(0) + 13 - 26); // get the new character
      }
      newString += newChar; // add the new character to the new string
    } else {
...
function toCamelCase(str) {
  ...
  for (let index = 0; index < stringArray.length; index++) {
    ...
    if (index === 0) {
      ...
      newString +=
        currentString.charAt(0).toLowerCase() + currentString.slice(1);
    }
  }
  return newString;
}
...
//  meme on love and code

function loveFunc(girlfriend, coding) {
  if (girlfriend === true && coding === true) {
    return true;
  } else if (girlfriend === false && coding === false) {
    return true;
  } else {
    return false;
  }
